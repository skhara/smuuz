 ...
 */
JNIEXPORT jboolean JNICALL Java_com_projects_sebastian_Smuuz_Backend_NativeWrapper_ninitLib(JNIEnv* env, jobject this)
{	 
	jint err = MPG123_ERR;
 ...
 */
JNIEXPORT void JNICALL Java_com_projects_sebastian_Smuuz_Backend_NativeWrapper_ncleanupLib(JNIEnv* env, jobject this)
{
	mpg123_delete(mh);
	mpg123_exit();
	mh = NULL;
 ...
 */
JNIEXPORT jstring JNICALL Java_com_projects_sebastian_Smuuz_Backend_NativeWrapper_ngetError(JNIEnv* env, jobject this)
{
 ...
 * Init one MP3 file
 */
JNIEXPORT jint JNICALL Java_com_projects_sebastian_Smuuz_Backend_NativeWrapper_ninitMP3(JNIEnv* env, jobject this, jstring filename)
{
	jint err = MPG123_ERR;
 ...
 */
void Java_com_projects_sebastian_Smuuz_Backend_NativeWrapper_ncleanupMP3(JNIEnv* env, jobject this)
{
	mpg123_close(mh);
}
 ...
 *
 */
JNIEXPORT jboolean JNICALL Java_com_projects_sebastian_Smuuz_Backend_NativeWrapper_nsetEQ(JNIEnv* env, jobject this, jint ch, jdouble val)
{
 ...
 *
 */
JNIEXPORT void JNICALL Java_com_projects_sebastian_Smuuz_Backend_NativeWrapper_nresetEQ(JNIEnv* env, jobject this)
{
	mpg123_reset_eq(mh);
}
 ...
 * Decode our MP3 file
 */
JNIEXPORT jint JNICALL Java_com_projects_sebastian_Smuuz_Backend_NativeWrapper_ndecodeMP3(JNIEnv* env, jobject this, jint inlen, jshortArray jpcm)
{
	jint err = MPG123_ERR;
	jint outlen = 0;
	jshort *pcm = NULL;
 ...
 */
JNIEXPORT void JNICALL Java_com_projects_sebastian_Smuuz_Backend_NativeWrapper_nseekTo(JNIEnv* env, jobject this, jint pos)
{
	if(mh != NULL)
